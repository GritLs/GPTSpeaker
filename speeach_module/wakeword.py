...
Hey-Murthy_en_windows_v2_2_0.ppn和Hey-Murthy_en_raspberry-pi_v2_2_0.ppn是唤醒词检测模型文件，在树莓派系统中用后者
可以离线唤醒（但是后续模块都需要联网）
"""
...
keyword_path = 'D:\Python  project\homework\embedded_homework\Hey-Murthy_en_windows_v2_2_0\Hey-Murthy_en_windows_v2_2_0.ppn'  # 你的唤醒词检测离线文件地址
